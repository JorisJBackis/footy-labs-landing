      ...
      <>
        ...
        <div className="flex flex-col bg-primary-dark overflow-hidden  ">
          <div className="basis-2/5 flex flex-col gap-1.5 sm:gap-1.5">
            ...
            <p className="text-primary-foreground">Analyse players performance based off
              <span className="relative">
              <Icons.highlight className="w-full absolute -bottom-2 left-0 text-yellow-mid"/>
                {` 40 + different metrics `}
              </span>
              available
              on the platform
            </p>
